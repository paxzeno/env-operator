...
import (
	...
	cachev1alpha1 "github.com/paxzeno/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.mars-crater.com/finalizer"
...
//+kubebuilder:rbac:groups=cache.mars-crater.com,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.mars-crater.com,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.mars-crater.com,resources=memcacheds/finalizers,verbs=update
